...
export default function Hero() {
  ...
  return (
    <section className="relative overflow-hidden bg-white isolate">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-2 items-center relative px-4 lg:px-10 2xl:px-44 py-10 xl:py-20 2xl:py-24">
          {/* dotted background */}
          ...
          <div className="flex justify-center lg:justify-end">
            <div className="relative w-full max-w-2xl">
              ...
              <div className="rounded-2xl border border-gray-200 bg-white shadow-[0_0_10px_rgba(0,100,255,0.2)] overflow-hidden
              pt-8">
                  ...
                  <div className="col-span-9 lg:col-span-6 bg-white px-4 pb-6">
                    <div className="text-center">
                      <div className="flex items-center gap-3 mb-3">
                        <div>
                          <div className="text-xl text-black font-bold">Try it Free</div>
                          <h3 className="text-md font-semibold text-gray-900 mt-2">Verify an email address instantly</h3>
                          <p className='text-[0.68rem] text-slate-600 mt-2'>Validate email addresses in real-time with our powerful API. Reduce bounce rates and improve deliverability.</p>
                        </div>
                      </div>
                      ...
                      <div>
                        <Button
                          className="px-5 py-2 min-w-[120px] whitespace-nowrap bg-blue-600 hover:bg-blue-900 text-white"
                        >
