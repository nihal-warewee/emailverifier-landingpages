...
const XIcon = () => (
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path fillRule="evenodd" clipRule="evenodd" d="M22.5 4.5C22.5 2.8425 21.1575 1.5 19.5 1.5H4.5C2.8425 1.5 1.5 2.8425 1.5 4.5V19.5C1.5 21.1575 2.8425 22.5 4.5 22.5H19.5C21.1575 22.5 22.5 21.1575 22.5 19.5V4.5Z" fill="#131313" />
    <path d="M5.65119 18.105H7.15119L11.1562 13.5525L14.6399 18.0975H18.7124L13.3687 11.0325L17.8912 5.89502H16.3912L12.6749 10.1175L9.48744 5.89877H5.28369L10.4549 12.645L5.64744 18.1088L5.65119 18.105ZM7.56744 7.02002H8.93244L16.4549 16.9725H15.1987L7.57119 7.02002H7.56744Z" fill="white" />
  </svg>
);
const FBIcon = () => (
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M18.4286 1.71436C19.4911 1.71436 20.3996 2.09159 21.1541 2.84605C21.9086 3.60052 22.2858 4.509 22.2858 5.5715V18.4286C22.2858 19.4911 21.9086 20.3996 21.1541 21.1541C20.3996 21.9086 19.4911 22.2858 18.4286 22.2858H15.9108V14.317H18.576L18.9777 11.2099H15.9108V9.22775C15.9108 8.72775 16.0157 8.35275 16.2255 8.10275C16.4353 7.85275 16.8438 7.72775 17.451 7.72775L19.0849 7.71436V4.94203C18.5224 4.86168 17.7277 4.8215 16.701 4.8215C15.4867 4.8215 14.5157 5.17864 13.788 5.89293C13.0603 6.60721 12.6965 7.61614 12.6965 8.91971V11.2099H10.0179V14.317H12.6965V22.2858H5.5715C4.509 22.2858 3.60052 21.9086 2.84605 21.1541C2.09159 20.3996 1.71436 19.4911 1.71436 18.4286V5.5715C1.71436 4.509 2.09159 3.60052 2.84605 2.84605C3.60052 2.09159 4.509 1.71436 5.5715 1.71436H18.4286Z" fill="#131313" />
  </svg>
...
export default function Footer() {
  return (
    <footer id="contact" className="bg-white relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16 pb-10 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-8">
          ...
          <div className="md:col-span-3 lg:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-serif text-slate-900">Email Verifier</span>
            </div>
            <p className="mb-6 leading-relaxed max-w-sm text-black">
            ...
            <div className="flex space-x-3">
              {socialLinks.map((link, index) => (
                <a
                  ...
                  className="w-9 h-9 border border-slate-200 rounded-full flex justify-center items-center hover:bg-slate-100 transition-colors"
                >
                  <link.icon />
                </a>
              ))}
          ...
          {/* Legal Links */}
          <div>
            <h3 className="text-lg font-semibold text-slate-900 mb-4">Legal Links</h3>
            <div className="space-y-3">
        ...
        <div className="border-t border-slate-200 mt-12 pt-6">
          <div className="flex items-center space-x-6">
            ...
            <a href="#" className="text-sm text-slate-500 hover:text-slate-800 transition-colors">Terms and condition</a>
          </div>
        </div>
      </div>
    </footer>
